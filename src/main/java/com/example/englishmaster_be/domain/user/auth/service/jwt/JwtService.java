package com.example.englishmaster_be.domain.user.auth.service.jwt;

import com.example.englishmaster_be.domain.user.auth.service.session_active.SessionActiveService;
...
public class JwtService {
    ...
    @Lazy
    public JwtService(JwtValue jwtValue, SessionActiveService sessionActiveService) {
