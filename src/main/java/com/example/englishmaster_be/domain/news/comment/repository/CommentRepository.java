package com.example.englishmaster_be.domain.news.comment.repository;
...
public interface CommentRepository extends JpaRepository<CommentEntity, UUID> {
    ...
    """, nativeQuery = true)
    List<IVotesCommentView> countVotesCommentIn(
    ...
    """, nativeQuery = true)
    List<ICountReplyCommentView> countReplyCommentIn(
            @Param("commentIds") List<UUID> commentIds
    );
}
