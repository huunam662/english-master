package com.example.englishmaster_be.domain.mock_test.speaking_submission.util.bot;
...
public class BotUtil {
    ...
    public static BotFeedbackRes feedback4Speaking(String sendContent) throws InterruptedException {
        ...
        try{
            ...
            return objectMapper.readValue(assistantContentJsonPretty, BotFeedbackRes.class);
        }
        catch (Exception e){
