package com.example.englishmaster_be.domain.exam.answer.repository;
...
public class AnswerJdbcRepository {
    ...
    @Lazy
    public AnswerJdbcRepository(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate, AppValue appValue) {
