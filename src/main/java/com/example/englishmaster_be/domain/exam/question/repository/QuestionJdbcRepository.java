package com.example.englishmaster_be.domain.exam.question.repository;
...
public class QuestionJdbcRepository {
    ...
    public QuestionJdbcRepository(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate, AppValue appValue) {
