...
public class MockTestUtil {
    ...
    public MockTestResultEntity initMockTestEntity(
        ...
        mockTestTotalCountResponse.setTotalScoreParts(
                mockTestTotalCountResponse.getTotalScoreParts() + PartHelper.totalScoreOfPart(partEntity)
        );

        mockTestTotalCountResponse.setTotalQuestionChildOfParts(
                mockTestTotalCountResponse.getTotalQuestionChildOfParts() + QuestionHelper.totalQuestionChildOf(partEntity.getQuestions())
        );
